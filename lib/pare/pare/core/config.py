...
hparams.DATASET.FOCAL_LENGTH = 5000.0
...
hparams.DATASET.DATASETS_AND_RATIOS = (
...
hparams.PARE.KEYPOINT_LOSS_WEIGHT = 5.0
hparams.PARE.KEYPOINT_NATIVE_LOSS_WEIGHT = 5.0
hparams.PARE.HEATMAPS_LOSS_WEIGHT = 5.0
hparams.PARE.SMPL_PART_LOSS_WEIGHT = 1.0
hparams.PARE.PART_SEGM_LOSS_WEIGHT = 1.0
hparams.PARE.POSE_LOSS_WEIGHT = 1.0
hparams.PARE.BETA_LOSS_WEIGHT = 0.001
hparams.PARE.OPENPOSE_TRAIN_WEIGHT = 0.0
hparams.PARE.GT_TRAIN_WEIGHT = 1.0
hparams.PARE.LOSS_WEIGHT = 60.0
...
def run_grid_search_experiments(
    ...
    if script == "occlusion_analysis.py":
        ...
        if config_to_run.DATASET.USE_GENDER:
            logdir = (config_to_run.LOG_DIR + "/evaluation_mesh_gender_" +
                      config_to_run.DATASET.VAL_DS)
        else:
            logdir = (config_to_run.LOG_DIR + "/evaluation_mesh_" +
                      config_to_run.DATASET.VAL_DS)
        ...
        if config_to_run.DATASET.USE_GENDER:
            logdir = (config_to_run.LOG_DIR + "/evaluation_mesh_j24_gender_" +
                      config_to_run.DATASET.VAL_DS)
        else:
            logdir = (config_to_run.LOG_DIR + "/evaluation_mesh_j24_" +
                      config_to_run.DATASET.VAL_DS)
    else:
        logdir = os.path.join(
            config_to_run.LOG_DIR,
            config_to_run.PROJECT_NAME,
            config_to_run.EXP_NAME,
            logdir + "_train",
        )
